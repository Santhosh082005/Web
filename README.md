...
int board[101]; // Declare board globally
...
int movePlayer(int currentPlayer, int roll) {
    ...
    // Ladders and Snakes
    snakesAndLadders[6] = 40;   // Ladder to 46
    snakesAndLadders[23] = -10; // Snake to 13
    ...
    int newSquare = newPosition;
    if (newPosition <= 100) {
        newSquare += snakesAndLadders[newPosition];
    }
